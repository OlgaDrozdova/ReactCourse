  ...
  return (
    <div>
      <div className={style.user_block}>
        ...
        <span className={style.user_block__text}>
      ...
      <div className={style.right_block}>
        ...
        <div className={style.university_block}>
          {itemsUniversity.length > 3
            ? itemsUniversity
                .slice(0, 3)
                .map((item) => (
                  <University pic={item.item_pic} desc={item.item_desc} />
                ))
            : itemsUniversity.map((item) => (
                <University pic={item.item_pic} desc={item.item_desc} />
              ))}
        </div>
        <div className={style.right_block__footer}>
          {itemsUniversity.length > 3 ? (
            <a>
              show all({itemsUniversity.length})
            </a>
          ) : (
            <></>
          )}
